...
// Set variables from POST parameters
    ...
    if($settings->updateLastName($userId, $password,  $lastName)){$success = true; } else{ $success = false; }
...
<div class="container">
    <div class="panel panel-default">
        <div class="panel-heading"><h2>Update Last Name</h2><i class="fa fa-link fa-1x"></i></div>
