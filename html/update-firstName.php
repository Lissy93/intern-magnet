    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Please enter your password and updated first name in the form below</h2><i class="fa fa-link fa-1x"></i></div>
                <div class="panel-body"  style="padding: 15px 20px;">
                    <div style="display: block; width: 260px; margin: 0 auto;">
                        <form action="/actions/update-firstName.php" method="post">
