    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Add Location</h2><i class="fa fa-link fa-1x"></i></div>
                <div class="panel-body"  style="padding: 15px 20px;">
                    <div style="display: block; width: 280px; margin: 0 auto;">
                        <form action="/actions/save-additional-details.php" method="post">
                            ...
                            <input name="slctType" type="hidden" value="location">
                            <br />
                            <input type="text" name="txtValue" placeholder="Location / City"
