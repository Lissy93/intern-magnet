    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel panel-default">
                <div class="panel-heading"><h2>Select your CV</h2><i class="fa fa-link fa-1x"></i></div>
                <div class="panel-body"  style="padding: 15px 20px;">
                    <div style="display: block; width: 360px; margin: 0 auto;">
                        <p>
                            Uploading your CV will allow potential employers to read more about your skill and experience. <br /><br />
                            Please ensure your CV is in PDF format, if you need to convert it <a href="http://www.freepdfconvert.com/" target="_blank" >click here</a>
                        </p>
                        <hr />
